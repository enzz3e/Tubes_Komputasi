                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-quantity">
                                        <a href="../repository/purchase_supplier/actionAddPurchase.php?action_type=remove_item&id=<?= $item->getId() ?>&product_name=<?= $item->getName() ?>&size=<?=$item->getSize()?>&quantity=1&price=<?= $item->getPrice() ?>" class="min">
                                            MIN
                                        </a>
                                        <a href="../repository/purchase_supplier/actionAddPurchase.php?action_type=add_item&id=<?= $item->getId() ?>&product_name=<?= $item->getName() ?>&size=<?=$item->getSize()?>&quantity=1&price=<?= $item->getPrice() ?>" class="plus">
                                            PLUS
                                        </a>
                                    </div>
                                </td>
